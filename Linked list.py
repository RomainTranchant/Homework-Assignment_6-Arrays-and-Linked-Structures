...
# Instructor: MD Ali
# Homework Assignment 6: Arrays and Linked Structures


# Import the time module to measure performance
import time
...
# Insert elements at the beginning and at the end
    test_linkedlist.insert_at_beginning(150)
    test_linkedlist.insert_at_beginning(90)
    test_linkedlist.insert_at_end(200)
    test_linkedlist.insert_at_end(300)
...
# Record the current time before starting operations
    start_time_linkedlist = time.time()
# Insert elements at the beginning and at the end
    test_linkedlist.insert_at_beginning(50)
    test_linkedlist.insert_at_end(350)
# Record the time after the operations
    end_time_linkedlist = time.time()
# Calculate the time taken for the operations
    elapsed_linkedlist = end_time_linkedlist - start_time_linkedlist
# Print the result in a formatted string with 9 decimals
    print(f"Time for insertion at beginning and at the end : {elapsed_linkedlist:.9f} seconds")
...
# Search for specific elements in the list
    print(f"Search for 20: {test_linkedlist.search(20)}")
    print(f"Search for 300: {test_linkedlist.search(300)}")

# Delete a node at a specific position
    test_linkedlist.delete_at_position(2)
