...
# Initialize an Array object with a capacity of 8, filled with zeros.
    array = Array(5, fill_value=0)
# Print the initial state of the array.
    print(f"The initial array: {array}")

# Update the second item (index 1) to 7
    array[1] = 7
    print(f"Array after updating the second item to 7: {array} ")
...
# Print the array after the insertion.
    print(f"Array after inserting 10 at index 0: {array}")

# Test the insertion method: insert 10 at index 3.
    array.insert(6, 16)
# Print the array after the insertion.
    print(f"Array after inserting 16 at index 6: {array}")
...
# Calculate the time taken for the operations
    elapsed_array = end_array_time - start_array_time
# Print the result in a formatted string with 9 decimals
    print(f"Time for insertion and deletion: {elapsed_array:.9f}")


# Test the increase_size method: increase the array size to 8.
    array.increase_size(8)
